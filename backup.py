...
def show_selection_page():
    st.title("Halaman Pemilihan Data")
...
def show_announcement_page():
    st.title("Halaman Tampilan Antrian")
...
with col1:
    if st.button("Pemilihan Data"):
        st.session_state.page = "Pemilihan Data"

with col2:
    if st.button("Tampilan Antrian"):
        st.session_state.page = "Tampilan Antrian"

if 'page' not in st.session_state:
    st.session_state.page = "Pemilihan Data"

if st.session_state.page == "Pemilihan Data":
    show_selection_page()
elif st.session_state.page == "Tampilan Antrian":
